...
public class ETMDScreen extends MainGameScreen {
    ...
    public boolean doodColided(LinkedList<Block> placed){
        ...
        System.out.println("LimInfX: " + limInfX);
        System.out.println("Dood x: " + dood.getCoords().X());
        System.out.println("LimSupX: " + limSupX);
        System.out.println("LimInfY: " + limInfY);
        System.out.println("Dood y: " + dood.getCoords().Y());
        System.out.println("LimSupY: " + limSupY);
